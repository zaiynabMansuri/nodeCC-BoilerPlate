...
router.route('/device/api/v1/banner/deleteMany').post(auth(...[ 'deleteManyByUserInDevicePlatform' ]),checkRolePermission,bannerController.deleteManyBanner);
...
router.route('/device/api/v1/banner/:id').post(auth(...[ 'getByUserInDevicePlatform' ]),checkRolePermission,bannerController.getBanner);
router.route('/device/api/v1/banner/delete/:id').delete(auth(...[ 'deleteByUserInDevicePlatform' ]),checkRolePermission,bannerController.deleteBanner);
