...
router.route('/device/api/v1/cart/deleteMany').post(auth(...[ 'deleteManyByUserInDevicePlatform' ]),checkRolePermission,cartController.deleteManyCart);
...
router.route('/device/api/v1/cart/:id').post(auth(...[ 'getByUserInDevicePlatform' ]),checkRolePermission,cartController.getCart);
router.route('/device/api/v1/cart/delete/:id').delete(auth(...[ 'deleteByUserInDevicePlatform' ]),checkRolePermission,cartController.deleteCart);
