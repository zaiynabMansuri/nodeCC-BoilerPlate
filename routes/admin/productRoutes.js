...
router.route('/admin/product/deleteMany').post(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),checkRolePermission,productController.deleteManyProduct);
...
router.route('/admin/product/:id').post(auth(...[ 'getByAdminInAdminPlatform' ]),checkRolePermission,productController.getProduct);
router.route('/admin/product/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),checkRolePermission,productController.deleteProduct);
