...
router.route('/admin/banner/deleteMany').post(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),checkRolePermission,bannerController.deleteManyBanner);
...
router.route('/admin/banner/:id').post(auth(...[ 'getByAdminInAdminPlatform' ]),checkRolePermission,bannerController.getBanner);
router.route('/admin/banner/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),checkRolePermission,bannerController.deleteBanner);
